...
contract GreenHydrogenCredit is AccessControl, ReentrancyGuard, Pausable {
    ...
    function verifyConsumer(address consumer) external {
   ...
   constructor() {
        // No need to grant DEFAULT_ADMIN_ROLE to anyone if you don't want admin restrictions
    }
    ...
    function addVerifier(address account) public {
